        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <button
              ...
              className="rounded-full border border-white/15 px-3 py-2 text-xs text-white transition hover:bg-white/10 sm:px-4 sm:text-sm"
            >
            ...
            <button
              ...
              className="rounded-full border border-red-400/30 px-3 py-2 text-xs text-red-300 transition hover:bg-red-400/10 sm:px-4 sm:text-sm"
            >
              削除する
            </button>
          </div>
